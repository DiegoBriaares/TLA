...
\@x{ {\VARIABLES} x ,\, y}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} ( x \.{=} 0 )}%
\@x{\@s{35.70} \.{\land} ( y\@s{0.10} \.{=} 0 )}%
\@pvspace{8.0pt}%
\@x{ FillSmall \.{\defeq} \.{\land} ( x \.{'} \.{=} 3 )}%
\@x{\@s{59.67} \.{\land} ( y \.{'}\@s{0.10} \.{=} y )}%
\@pvspace{8.0pt}%
\@x{ FillBig \.{\defeq} \.{\land} ( x \.{'} \.{=} x )}%
\@x{\@s{49.69} \.{\land} ( y \.{'}\@s{0.10} \.{=} 5 )}%
\@pvspace{8.0pt}%
\@x{ EmptySmall \.{\defeq} \.{\land} ( x \.{'} \.{=} 0 )}%
\@x{\@s{72.70} \.{\land} ( y \.{'}\@s{0.10} \.{=} y )}%
\@pvspace{8.0pt}%
\@x{ EmptyBig \.{\defeq} \.{\land} ( x \.{'} \.{=} x )}%
\@x{\@s{62.72} \.{\land} ( y \.{'}\@s{0.10} \.{=} 0 )}%
\@pvspace{8.0pt}%
\@x{ PourFromSmall \.{\defeq} \.{\lor} ( \.{\land} ( x \.{\leq} 5 \.{-} y )}%
\@x{\@s{103.89} \.{\land} ( x \.{'} \.{=} 0 )}%
\@x{\@s{103.89} \.{\land} ( y \.{'}\@s{0.10} \.{=} x \.{+} y ) )}%
\@x{\@s{88.68} \.{\lor} ( \.{\land} ( x \.{>} 5 \.{-} y )}%
\@x{\@s{103.89} \.{\land} ( x \.{'} \.{=} x \.{-} 5 \.{+} y )}%
\@x{\@s{103.89} \.{\land} ( y \.{'}\@s{0.10} \.{=} 5 ) )}%
\@pvspace{8.0pt}%
 \@x{ PourFromBig \.{\defeq} \.{\lor} ( \.{\land} ( y \.{\leq} 3\@s{3.96}
 \.{-} x )}%
\@x{\@s{93.92} \.{\land} ( x \.{'} \.{=} x \.{+} y )}%
\@x{\@s{93.92} \.{\land} ( y \.{'}\@s{0.10} \.{=} 0 ) )}%
\@x{\@s{78.71} \.{\lor} ( \.{\land} ( y \.{>} 3 \.{-} x )}%
\@x{\@s{93.92} \.{\land} ( x \.{'} \.{=} 3 )}%
\@x{\@s{93.92} \.{\land} ( y \.{'}\@s{0.10} \.{=} y \.{-} 3 \.{+} x ) )}%
\@pvspace{16.0pt}%
\@x{ Next \.{\defeq} \.{\lor} FillSmall}%
\@x{\@s{39.83} \.{\lor} FillBig}%
\@x{\@s{39.83} \.{\lor} EmptySmall}%
\@x{\@s{39.83} \.{\lor} EmptyBig}%
\@x{\@s{39.83} \.{\lor} PourFromSmall}%
\@x{\@s{39.83} \.{\lor} PourFromBig}%
\@pvspace{16.0pt}%
\@x{ TypeOK \.{\defeq} \.{\land} ( x \.{\in} 0 \.{\dotdot} 3 )}%
\@x{\@s{56.14} \.{\land} ( y\@s{0.10} \.{\in} 0 \.{\dotdot} 5 )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Apr} 12
 10:44:26 \ensuremath{CST} 2026 by \ensuremath{digogonz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Apr} 12 09:24:29
 \ensuremath{CST} 2026 by \ensuremath{digogonz
}%
\end{cpar}%
\end{lcom}%
\end{document}
