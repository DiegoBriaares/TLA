...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TransCommit}\moduleRightDash\@xx{}%
\@pvspace{16.0pt}%
\@x{ {\CONSTANT} RM}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} rmState}%
...
\@pvspace{8.0pt}%
 \@x{ TCInit \.{\defeq}\@s{8.2} rmState\@s{12.23} \.{=} [ r \.{\in} RM
 \.{\mapsto}\@w{working} ]}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 15 16:17:59 \ensuremath{CST} 2026 by \ensuremath{digogonz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Apr} 13
 17:14:49 \ensuremath{CST} 2026 by \ensuremath{digogonz
}%
\end{cpar}%
\end{lcom}%
\end{document}
